...
// Dynamically create a path for deposit of images files
// $xx = $_SERVER['SCRIPT_NAME'];
// $xxy = /forums/vanilla/plugins/CustomPages/pages/images;  // str_replace("CMS/subsys/newfileCreate.php","CustomPages/pages/images",$xx);
...
-------------------------------------------------------------------*/
	...
	$config['img_path'] = '/freeze/uploads/images';
